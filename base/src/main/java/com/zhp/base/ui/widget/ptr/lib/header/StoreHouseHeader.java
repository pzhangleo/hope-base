...
import com.zhp.base.ui.widget.ptr.lib.PtrUIHandler;
import com.zhp.base.ui.widget.ptr.lib.indicator.PtrIndicator;
import com.zhp.base.ui.widget.ptr.lib.util.PtrLocalDisplay;
...
public class StoreHouseHeader extends View implements PtrUIHandler {
    ...
    public void initWithString(String str, int fontSize) {
        ArrayList<float[]> pointList = com.zhp.base.ui.widget.ptr.lib.header.StoreHousePath.getPath(str, fontSize * 0.01f, 14);
