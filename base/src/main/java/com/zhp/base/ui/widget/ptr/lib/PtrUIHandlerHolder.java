 ...
 */
class PtrUIHandlerHolder implements com.zhp.base.ui.widget.ptr.lib.PtrUIHandler {

    private com.zhp.base.ui.widget.ptr.lib.PtrUIHandler mHandler;
    private PtrUIHandlerHolder mNext;

    private boolean contains(com.zhp.base.ui.widget.ptr.lib.PtrUIHandler handler) {
    ...
    private com.zhp.base.ui.widget.ptr.lib.PtrUIHandler getHandler() {
        return mHandler;
    }

    public static void addHandler(PtrUIHandlerHolder head, com.zhp.base.ui.widget.ptr.lib.PtrUIHandler handler) {
    ...
    public static PtrUIHandlerHolder removeHandler(PtrUIHandlerHolder head, com.zhp.base.ui.widget.ptr.lib.PtrUIHandler handler) {
    ...
    public void onUIReset(com.zhp.base.ui.widget.ptr.lib.PtrFrameLayout frame) {
        ...
        do {
            final com.zhp.base.ui.widget.ptr.lib.PtrUIHandler handler = current.getHandler();
            if (null != handler) {
