package zhp.base.ui.widget.ptr.lib.header;
...
import zhp.base.ui.widget.ptr.lib.PtrFrameLayout;
import zhp.base.ui.widget.ptr.lib.PtrUIHandler;
import zhp.base.ui.widget.ptr.lib.indicator.PtrIndicator;
import zhp.base.ui.widget.ptr.lib.util.PtrLocalDisplay;
...
public class StoreHouseHeader extends View implements PtrUIHandler {
    ...
    public void initWithString(String str, int fontSize) {
        ArrayList<float[]> pointList = zhp.base.ui.widget.ptr.lib.header.StoreHousePath.getPath(str, fontSize * 0.01f, 14);
