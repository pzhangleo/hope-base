 ...
 */
class PtrUIHandlerHolder implements zhp.base.ui.widget.ptr.lib.PtrUIHandler {

    private zhp.base.ui.widget.ptr.lib.PtrUIHandler mHandler;
    private PtrUIHandlerHolder mNext;

    private boolean contains(zhp.base.ui.widget.ptr.lib.PtrUIHandler handler) {
    ...
    private zhp.base.ui.widget.ptr.lib.PtrUIHandler getHandler() {
        return mHandler;
    }

    public static void addHandler(PtrUIHandlerHolder head, zhp.base.ui.widget.ptr.lib.PtrUIHandler handler) {
    ...
    public static PtrUIHandlerHolder removeHandler(PtrUIHandlerHolder head, zhp.base.ui.widget.ptr.lib.PtrUIHandler handler) {
    ...
    public void onUIReset(zhp.base.ui.widget.ptr.lib.PtrFrameLayout frame) {
        ...
        do {
            final zhp.base.ui.widget.ptr.lib.PtrUIHandler handler = current.getHandler();
            if (null != handler) {
