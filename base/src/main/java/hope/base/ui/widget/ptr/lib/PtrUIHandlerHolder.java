 ...
 */
class PtrUIHandlerHolder implements hope.base.ui.widget.ptr.lib.PtrUIHandler {

    private hope.base.ui.widget.ptr.lib.PtrUIHandler mHandler;
    private PtrUIHandlerHolder mNext;

    private boolean contains(hope.base.ui.widget.ptr.lib.PtrUIHandler handler) {
    ...
    private hope.base.ui.widget.ptr.lib.PtrUIHandler getHandler() {
        return mHandler;
    }

    public static void addHandler(PtrUIHandlerHolder head, hope.base.ui.widget.ptr.lib.PtrUIHandler handler) {
    ...
    public static PtrUIHandlerHolder removeHandler(PtrUIHandlerHolder head, hope.base.ui.widget.ptr.lib.PtrUIHandler handler) {
    ...
    public void onUIReset(hope.base.ui.widget.ptr.lib.PtrFrameLayout frame) {
        ...
        do {
            final hope.base.ui.widget.ptr.lib.PtrUIHandler handler = current.getHandler();
            if (null != handler) {
